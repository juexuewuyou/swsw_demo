<template>
  <div class="shujia1">
    ...
    <!-- 底部导航 -->
    <mt-tabbar fixed id="mtbar" :style="dbyc">
      <mt-tab-item>
        <img
          v-if="false"
    ...
    <div id="dibu" :style="xss">
      <span class="left"> <input type='checkbox' v-model='checked' @click='checkedAll'>全选</span>
...
export default{
  ...
  //     '/shujia'
  //     ).then(result=>{
  //       this.sw_favorite= result.data.results
  // })
  },
  watch: { //深度 watcher
      arr: {
